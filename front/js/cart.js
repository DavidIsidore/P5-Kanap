...
function validateFirstName(firstName) {
  ...
  if (txtRegex.test(firstName) == false) {
    ...
    firstNameErrorMsg.innerHTML =
      "Veuillez saisir un format de prénom valide (uniquement des lettres)";
    return false;
  } else {
    firstNameErrorMsg.innerHTML = "";
    return true;
...
function validateLastName(lastName) {
  if (txtRegex.test(lastName) == false) {
    lastNameErrorMsg.innerHTML =
      "Veuillez saisir un format de nom valide (uniquement des lettres)";
    return false;
  } else {
    lastNameErrorMsg.innerHTML = "";
    return true;
...
function validateAddress(address) {
  if (addressRegex.test(address) == false) {
    addressErrorMsg.innerHTML =
      "Veuillez saisir un format d'adresse valide (lettres et chiffres, pas de symbole spécial)";
    return false;
  } else {
    addressErrorMsg.innerHTML = "";
...
function validateEmail(email) {
  if (emailRegex.test(email) == false) {
    emailErrorMsg.innerHTML =
      "Veuillez saisir un format d'adresse mail valide ( exemple@fournisseur.fr)";
    return false;
  } else {
    emailErrorMsg.innerHTML = "";
